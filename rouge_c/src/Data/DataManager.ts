	...
	export class DataManager {
		...
		public static init() {
			DataManager.goodsDatas = [
				...
				new GoodsItemData(2002,"resource/assets/chongzhi/lipin2.png", "化妆镜", GameType.CHUANG_GUAN, "￥:118", GoodsType.LI_PIN, 100),
				...
				new GoodsItemData(3006,"resource/assets/chongzhi/pifu6.png", "1888皮肤系列", GameType.CHUANG_GUAN, "￥:188.80", GoodsType.PI_FU, 300),
